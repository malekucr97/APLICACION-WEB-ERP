...
@Component({selector: 'app-alfa-beta-riesgo-credito',
            templateUrl: './alfa-beta.component.html',
            // styleUrls: ['../../../../assets/scss/tailwind.scss'],
            standalone: false
})
export class AlfaBetaComponent implements OnInit {
  _rutaArchivo: string = '';
  _archivo: any;
  ...
  private nombrePantalla:string = 'alfa-beta.html';
