...
@Component({selector: 'app-z-altman-riesgo-credito',
            templateUrl: './zaltman.component.html',
            styleUrls: ['../../../../assets/scss/tailwind.scss'],
            standalone: false
})
export class ZAltmanComponent implements OnInit {
  _rutaArchivo: string = '';
  _archivo: any;
  ...
  private nombrePantalla:string = 'zaltman.html';
