...
export class TipoCambioComponent implements OnInit {
    ...
    // ## -- listas analisis -- ## //
    public listTiposMonedas  : GenTipoMoneda[]  = [];
    public listObjetosTipoCambio  : GenTipoCambio[]  = [];
    ...
    consultarWSBCCRTipoCambio() : void {
        ...
        this.generalesService.requestTipoCambioBCCR(bccrIndicadorCompra, bccrIndicadorVenta, idMoneda, this.companiaObservable.id, fechaConsultaCompleta)
            .pipe(first())
    ...
    buscarMoneda(getAll : boolean = false) : void {
        ...
        this.generalesService.getTiposMonedas(codigoMoneda, this.companiaObservable.id, true)
            .pipe(first())
            .subscribe(response => {
    ...
    buscarTipoCambio(getAll : boolean = false) : void {
        ...
        this.generalesService.getTipoCambio(idMoneda, this.companiaObservable.id, fechaConsultaCompleta)
            .pipe(first())
            .subscribe(response => {
    ...
    consultaTiposCambio(obj: GenTipoMoneda) : void {

        this.generalesService.getTipoCambio(obj.id, this.companiaObservable.id, '%%')
            .pipe(first())
    ...
    selectMoneda(moneda : GenTipoMoneda) : void {

        this.inicializaFormTipoMoneda(moneda);
        this.consultaTiposCambio(moneda);
    }
    selectObjectListTipoCambio(objeto : GenTipoCambio) : void {

        this.inicializaFormularioTipoCambio(objeto);
    }

    inicializaFormTipoMoneda(objetoMoneda : GenTipoMoneda = null)       : void {
        ...
        if (objetoMoneda) {
            ...
            this.habilitaTipoCambioMoneda = false;
        }
    }

    inicializaFormularioTipoCambio(objeto : GenTipoCambio = null) : void {
    ...
    crearMonedaObjectForm() : GenTipoMoneda {
        ...
        var monedaForm = new GenTipoMoneda (codigo_moneda, this.companiaObservable.id, descripcion, simbolo, bccrIndicadorCompra, bccrIndicadorVenta, estado) ;

        return monedaForm ;
    }
    createObjectFormTipoCambio() : GenTipoCambio {
        ...
        var objectForm = new GenTipoCambio (this.companiaObservable.id, idMoneda, montoCompra, montoVenta, fechaConsulta) ;
    ...
    submitMoneda() : void {
        ...
        var monedaForm : GenTipoMoneda = this.crearMonedaObjectForm();
        
        monedaForm.adicionadoPor    = this.userObservable.identificacion;
        monedaForm.fechaAdicion     = this.today;

        this.generalesService.postTipoMoneda(monedaForm)
            .pipe(first())
            .subscribe(response => {
    ...
    submitFormTipoCambio() : void {
        ...
        var objectForm : GenTipoCambio = this.createObjectFormTipoCambio();
        
        objectForm.adicionadoPor    = this.userObservable.identificacion;
        objectForm.fechaAdicion     = this.today;

        this.generalesService.postTipoCambio(objectForm)
            .pipe(first())
            .subscribe(response => {
    ...
    eliminarMoneda() : void {
        ...
        .subscribe((confirmado: Boolean) => {
            ...
            if (confirmado) {
                ...
                this.generalesService.deleteTipoMoneda( id )
                    .pipe(first())
                    .subscribe(response => {
                        if (response.exito) {
    ...
    eliminarTipoCambio() : void {
        ...
        .subscribe((confirmado: Boolean) => {
            ...
            if (confirmado) {
                ...
                this.generalesService.deleteTipoCambio( id )
                    .pipe(first())
                    .subscribe(response => {
                        if (response.exito) {
    ...
    actualizaMoneda() : void {
        ...
        this.generalesService.putTipoMoneda(monedaForm)
            .pipe(first())
            .subscribe(response => {
    ...
    actualizaObjetoMontoPersona() : void {
        ...
        this.generalesService.putTipoCambio(objectForm)
            .pipe(first())
            .subscribe(response => {
