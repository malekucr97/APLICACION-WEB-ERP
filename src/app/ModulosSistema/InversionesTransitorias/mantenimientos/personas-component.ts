        ...
        this.inversionesService.postPersona(objectForm)
            ...
            .subscribe(response => {
                ...
                if ( response ) {
                    ...
                    this.alertService.success( this.translate.translateKeyP('ALERTS.SUCCESSFUL_PERSON_REGISTRATION',{$PH:response.identificacion}) );
        ...
        this.inversionesService.postMontosPersona(objectForm)
            ...
            .subscribe(response => {
                ...
                if ( response ) {
                    ...
                    this.alertService.success( this.translate.translateKey('ALERTS.SUCCESSFUL_AMOUNT_REGISTRATION') );
        ...
        this.inversionesService.putPersona(objectForm)
            ...
            .subscribe(response => {
                ...
                if ( response ) {
                    ...
                    this.alertService.success( this.translate.translateKeyP('ALERTS.SUCCESSFUL_PERSON_UPDATE',{$PH:response.identificacion}) );
        ...
        this.inversionesService.putMontoPersona(objectForm)
            ...
            .subscribe(response => {
                ...
                if ( response ) {
                    ...
                    this.alertService.success( this.translate.translateKey('ALERTS.SUCCESSFUL_PERSON_AMOUNT_UPDATE') );
